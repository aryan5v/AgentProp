...
- [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) — how modules connect
- [docs/index.md](docs/index.md) — documentation map
- [docs/environment.md](docs/environment.md) — env vars and tiers
- [CONTRIBUTING.md](CONTRIBUTING.md) — quality gates and data policy
- [examples/minimal_control_loop.py](examples/minimal_control_loop.py) — runtime integration
...
1. Define a workflow JSON per [docs/workflow_schema.md](docs/workflow_schema.md)
...
See [docs/control_layer_quickstart.md](docs/control_layer_quickstart.md).
