...
def test_codex_plugin_manifest_points_to_packaged_skill_and_mcp() -> None:
    plugin_root = REPO_ROOT / "integrations" / "coding-agents" / "agentprop"
    manifest = json.loads(
...
def test_claude_marketplace_exposes_agentprop_plugin() -> None:
    ...
    assert entries["agentprop"]["source"] == "./integrations/coding-agents/agentprop"
