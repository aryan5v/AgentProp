...
[`distribution/skills/agentprop-workflow-optimizer/`](../../../skills/agentprop-workflow-optimizer/).

For the full Claude Code plugin, use
[`distribution/plugins/agentprop`](../../../plugins/agentprop), which includes the Claude
...
- `distribution/skills/agentprop-workflow-optimizer/SKILL.md` (canonical), or
