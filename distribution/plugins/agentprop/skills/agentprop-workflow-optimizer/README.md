...
```bash
npx skills add \
  https://github.com/aryan5v/AgentProp/tree/main/distribution/skills/agentprop-workflow-optimizer
```
...
`distribution/wrappers/claude-code/agentprop-workflow-optimizer/` is a thin Claude Code
